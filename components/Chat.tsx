  ...
  return (
    <div className="flex flex-col h-full overflow-scroll">
      ...
      <div className="flex-1 w-full">
        ...
        {loading ? (
          <div className="flex items-center justify-center">
            <Loader2Icon className="animate-spin h-20 w-20 text-grey-600 mt-20" />
          </div>
        ) : (
          <div className="p-5">
            {messages.length === 0 && (
      ...
      <form
        ...
        className="flex sticky bottom-0 space-x-2 p-5 bg-grey-600/75"
      >
        <Input
        ...
        <Button type="submit" disabled={!input || isPending}>
          {isPending ? (
            <Loader2Icon className="animate-spin text-grey-600" />
          ) : (
            "Ask"
          )}
        </Button>
